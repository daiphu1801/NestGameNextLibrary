...
import { useGamepadConfig } from '@/features/settings/hooks/useGamepadConfig';
import {
    emulatorService,
    GamepadConfig,
    GamepadButtonMap,
...
const GAME_BUTTONS: { id: NesButton; icon: string; color: string; systems?: string }[] = [
...
export function GamepadSelector() {
    const {
        config, activePlayer, setActivePlayer, listening, setListening,
        isSaving, saveSuccess, message, hasChanges, showGuide, setShowGuide,
        connectedPad, handleSave, handleReset, getButtonLabel, t
    } = useGamepadConfig();
